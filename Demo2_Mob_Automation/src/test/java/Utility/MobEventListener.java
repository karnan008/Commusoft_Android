...
public class MobEventListener extends CommusoftDevBaseClass implements AppiumWebDriverEventListener{
	...
	public void onException(Throwable error, AndroidDriver<MobileElement> driver) {
		...
		CommusoftDevBaseClass testbase = new CommusoftDevBaseClass();
