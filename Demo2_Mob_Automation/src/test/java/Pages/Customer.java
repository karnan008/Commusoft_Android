...
//	   click("//*[@text='Title']/following::*[@class='android.widget.Spinner']");
	...
	{
		ExplicitWait_PresenceOfEle("//*[@resource-id='com.commusoft.v4:id/search_button']");
...
//		click("#com.commusoft.v4:id/spinnerserviceTypeView");
	...
	{
		ExplicitWait_ElementToBeClickable("//*[@text='Service type *']/following-sibling::*[@class='android.widget.Spinner']");
		click("//*[@text='Service type *']/following-sibling::*[@class='android.widget.Spinner']");
	}
...
//		click("//android.widget.TextView[@text='AC service']");
	...
	public void Sendto(String editname,String surname) throws InterruptedException
	{
		Thread.sleep(3000);
//		click("#com.commusoft.v4:id/spinnersendToView");
		...
		ExplicitWait_ElementToBeClickable("//*[@text='Mr & Mrs "+editname+" "+surname+" - Email']");
		
		click("//*[@text='Mr & Mrs "+editname+" "+surname+" - Email']");
		Thread.sleep(4000);
