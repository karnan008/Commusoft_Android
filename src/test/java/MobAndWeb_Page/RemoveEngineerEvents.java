		...
		do {
			...
			while(emptyPage.contains("Estimate No:") || emptyPage.contains("Job No:")) {
				...
				else if(pageSource.contains("Estimate description")) 
				{
					...
					click("//*[@text='REJECT']");//Click reject
					...
					click("//*[@resource-id='android:id/text1']");//Click dropdown
					ExplicitWait_ElementToBeClickable("(//*[@resource-id='android:id/text1'])[2]");
					click("(//*[@resource-id='android:id/text1'])[2]");// Select reason
					ExplicitWait_ElementToBeClickable("//*[@text='REJECT']");
					click("//*[@text='REJECT']");//Click reject button
