...
public class AssetNewUIMob extends Wrapper {
	...
	public void EnableNewAssets() {
		...
		String assetYesOrNo = driver.findElement(By.xpath(
				"//androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View[2]/android.view.View/android.widget.TextView"))
				.getText();
	...
	public void Verify_DeletedCustomerAsset() // *[@text='There are currently no assets saved against this property,
												// click to add one']
	{
	...
	public void Verify_JobAssets() {
		ExplicitWait_PresenceOfEle("(//*[@class='android.widget.TextView'])[1]");
		MobileElement jobAsset = driver.findElement(By.xpath("(//*[@class='android.widget.TextView'])[1]"));
		Verify_AssertTrue(jobAsset);
