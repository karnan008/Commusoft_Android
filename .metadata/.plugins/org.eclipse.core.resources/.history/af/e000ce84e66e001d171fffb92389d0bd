...
public class Standard_Smoke_Testing_Android extends MainPack.BaseClass{
	...
	public void Create_Estimate1() throws InterruptedException
	{
		...
		customer.Customer_Searchtext(Name, Surname); 
		MobileEnter();
		add_Notes.Click_Cus(Name, Surname); 
		...
		//doubleclickpoint(500,510);//simulator 392,399
		doubleclickpoint(260,890);
		estimate.Book_Event(1019, 849, 79, 856,260,890);
		estimate.Savebtn();


	}
	@Test (enabled=false)// enabled=false priority = 2
	public void Estimate1_Accept_On_Diary() throws InterruptedException
	{
		...
		//clickpoint(500, 400);
		scrolltothetop(500,500,500,2400);// For Separate Test Case, Incase run overall test cases, remove this.
		...
		//		signature(220, 2100, 700, 1890);//simulator Command at 10-Nov (15:29)
		Thread.sleep(4000);
	...
	public void Create_Estimate2() throws InterruptedException
	{
		...
		doubleclickpoint(280,1050);//simulator
		//		doubleclickpoint(400,1250);//simulator
		estimate.Book_Event(1019, 849, 79, 856,280,1050);
		estimate.Savebtn();
	}
	...
	public void Estimate2_Reject_On_Diary() throws InterruptedException
	{
		...
		estimate.Estimate_Leave();
		//signature(200, 1300, 500, 900);
		//		signature(300, 1700, 900, 1400);//simulator Commend this line by Saravanan
		signature(260, 1250, 788, 1078);
		estimate.Sign_save();
		//signature(250, 1000, 650, 850);
		signature(272, 938, 380, 1068);//simulator
		estimate.Sign_save();
	...
	public void Create_Job1() throws InterruptedException
	{
		...
		doubleclickpoint(285, 1220);//simulator
	...
	public void Create_2Job() throws InterruptedException
	{
		...
		doubleclickpoint(300,1450);
		estimate.Book_Event(1019, 849, 79, 856,300,1450);
		estimate.Savebtn();
	}
...
//	}
	...
	@Test(enabled=false)//enabled=false  priority = 9
